...
public class StudentInstituteComplaintsFragment extends Fragment {
    private ArrayList<Complaint> Complaints;
    protected RecyclerView mRecyclerView;
    protected RecyclerView.LayoutManager mLayoutManager;
    protected View rootView;
    private Context mContext;
    protected StudentInstituteComplaintsAdapter mAdapter;
    NetworkOperations network ;
    Gson gson ;
    User user;
    public static class ImplementListener implements ResponseListener {
        WeakReference<StudentInstituteComplaintsFragment> activity;
        ImplementListener(StudentInstituteComplaintsFragment activity) {
            this.activity = new WeakReference(activity);
        }
        @Override
        public void onSuccess(String response , String URL){
            StudentInstituteComplaintsFragment activity=this.activity.get();
            JSONObject json;
            try{
    ...
    public StudentInstituteComplaintsFragment() {
    ...
    static class StudentInstituteComplaintsAdapter extends RecyclerView.Adapter<StudentInstituteComplaintsAdapter.ViewHolder> {
        ...
        StudentInstituteComplaintsAdapter(ArrayList<Complaint> DataSet,Context context) {
            mDataSet = DataSet;
            mContext = context;
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootView = inflater.inflate(R.layout.fragment_student_institute_complaints, container, false);
        mRecyclerView = (RecyclerView) rootView.findViewById(R.id.institute_card_recycler_view) ;
        mLayoutManager = new LinearLayoutManager(mContext);
        requestComplaints(0,100,0,2);
        return rootView;
    }
    ...
    public void onResume(){
        ...
        if(mAdapter == null)
            mAdapter = new StudentInstituteComplaintsAdapter(Complaints,mContext);
    ...
    public void removeTag(String compid){
        String url = "http://192.168.56.1:8000/remove_tag";
        url+="?compid=" + compid ;
